document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkBoard() {
        //make constant that shows all winning arrays
        const winningArrays = [
        ...
        for( let y = 0; y < winningArrays.length; y++ ) {
            ...
            if(square1.classList.contains('player-one') &&
                ...
                //now check to see if they all have the class name of the player-two
    ...
    //add an eventListenner to each square that will triggere the checkBoard function on click
